...
if ("${CMAKE_C_COMPILER_ID}" STREQUAL "GNU" AND "${CMAKE_Fortran_COMPILER_ID}" STREQUAL "GNU")
  ...
  set(NWCHEM_Fortran_COMPILE_FLAGS ${NWCHEM_Fortran_COMPILE_FLAGS} -g -m64 -ffast-math -Warray-bounds -fdefault-integer-8)

  set(NWCHEM_Fortran_DEBUG_FLAGS -O2 -g -fno-aggressive-loop-optimizations)
  
  if(CPU_X86_64)
    set(NWCHEM_Fortran_COMPILE_FLAGS ${NWCHEM_Fortran_COMPILE_FLAGS} -g -finline-functions)
    set(NWCHEM_Fortran_DEBUG_FLAGS ${NWCHEM_Fortran_DEBUG_FLAGS} -g -O)
  endif()

  set(NWCHEM_Fortran_OPTIMIZE_FLAGS ${NWCHEM_Fortran_OPTIMIZE_FLAGS} -g -O2 -Wuninitialized -fno-aggressive-loop-optimizations)
  
  if(CPU_X86_64)
    set(NWCHEM_Fortran_OPTIMIZE_FLAGS ${NWCHEM_Fortran_OPTIMIZE_FLAGS} -g -O3 -mfpmath=sse -ffast-math -fprefetch-loop-arrays -ftree-vectorize -fopt-info-vec -mtune=native) 
    if (CMAKE_C_COMPILER_VERSION GREATER_EQUAL 6.0)
      set(NWCHEM_Fortran_OPTIMIZE_FLAGS ${NWCHEM_Fortran_OPTIMIZE_FLAGS} -g -fno-tree-dominator-opts)
    endif()
  endif()

  set(NWCHEM_C_COMPILE_FLAGS ${NWCHEM_C_COMPILE_FLAGS} -g -m64 -Wall)

  if(CPU_X86_64)  
    set(NWCHEM_C_COMPILE_FLAGS ${NWCHEM_C_COMPILE_FLAGS} -O3 -funroll-loops -ffast-math)
    set(NWCHEM_C_OPTIMIZE_FLAGS ${NWCHEM_C_OPTIMIZE_FLAGS} -g -O1)
  elseif(CPU_ppc64le)
