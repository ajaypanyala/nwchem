...
// created by tc_gen_global_methods()
void pre_SD2_Functions_1();
void pre_SD2_Functions_2();
void pre_BasicBlock_1();
void pre_BasicBlock_2();
void pre_IndirectArray_1();
void pre_IndirectArray_2();
...
void Pre_PreComputedArrays_1(int*& h_t3_output_base_addr, 
							...
							int n_blocks, 
							int size_idx_h3, 		int size_idx_h2,		int size_idx_h1,		int size_idx_p6, 		int size_idx_p5, 	int size_idx_p4, 		int size_idx_h7)
{
	//
	int	STR_SD2_T3_H3 = 1;
	...
	h_t3_output_base_addr             = (int*)malloc(sizeof(int) * (n_blocks));
	h_t2_4_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_1_P5 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_H1 * n_blocks);
	h_v2_4_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_1_H3 * SIZE_SLICE_1_H2 * SIZE_SLICE_1_P4 * n_blocks);

	h_t2_5_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_1_P5 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_H2 * n_blocks);
	h_v2_5_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_1_H3 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_P4 * n_blocks);

	h_t2_6_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_1_P5 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_H3 * n_blocks);
	h_v2_6_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_1_H2 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_P4 * n_blocks);

	h_t2_7_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_1_P4 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_H1 * n_blocks);
	h_v2_7_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_1_H3 * SIZE_SLICE_1_H2 * SIZE_SLICE_1_P5 * n_blocks);

	h_t2_8_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_1_P4 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_H2 * n_blocks);
	h_v2_8_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_1_H3 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_P5 * n_blocks);

	h_t2_9_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_1_P4 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_H3 * n_blocks);
	h_v2_9_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_1_H2 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_P5 * n_blocks);
	...
	for (int i = 0; i < n_blocks; i++)
	{
		...
		// Calculating t3
		h_t3_output_base_addr[i] = blk_idx_h3 * SIZE_SLICE_1_H3 * STR_SD2_T3_H3 + blk_idx_h2 * SIZE_SLICE_1_H2 * STR_SD2_T3_H2 + blk_idx_h1 * SIZE_SLICE_1_H1 * STR_SD2_T3_H1 + blk_idx_p6 * SIZE_SLICE_1_P6 * STR_SD2_T3_P6 + blk_idx_p5 * SIZE_SLICE_1_P5 * STR_SD2_T3_P5 + blk_idx_p4 * SIZE_SLICE_1_P4 * STR_SD2_T3_P4;
		...
		{
			int l_offset = idx_p6 + (idx_h1 + (idx_p5) * SIZE_SLICE_1_H1) * SIZE_SLICE_1_P6;
			h_t2_4_ext_addr[l_offset + i * SIZE_SLICE_1_P5 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_P6] = (blk_idx_p5 * SIZE_SLICE_1_P5 + idx_p5 + 
				(blk_idx_p6 * SIZE_SLICE_1_P6 + idx_p6 + (blk_idx_h1 * SIZE_SLICE_1_H1 + idx_h1) * size_idx_p6) * size_idx_p5) * size_idx_h7;
		}
		...
		{
			int l_offset = idx_h3 + (idx_h2 + (idx_p4) * SIZE_SLICE_1_H2) * SIZE_SLICE_1_H3;
			h_v2_4_ext_addr[l_offset + i * SIZE_SLICE_1_P4 * SIZE_SLICE_1_H2 * SIZE_SLICE_1_H3] = blk_idx_h3 * SIZE_SLICE_1_H3 + idx_h3 + (blk_idx_h2 * SIZE_SLICE_1_H2 + idx_h2 + 
																								(blk_idx_p4 * SIZE_SLICE_1_P4 + idx_p4) * size_idx_h2) * size_idx_h3;
		}
		...
		for (int idx_p6 = 0; idx_p6 < SIZE_SLICE_1_P6; idx_p6++)
		{
			int l_offset = idx_p6 + (idx_h2 + (idx_p5) * SIZE_SLICE_1_H2) * SIZE_SLICE_1_P6;
			h_t2_5_ext_addr[l_offset + i * SIZE_SLICE_1_P5 * SIZE_SLICE_1_H2 * SIZE_SLICE_1_P6] = (blk_idx_p5 * SIZE_SLICE_1_P5 + idx_p5 + (blk_idx_p6 * SIZE_SLICE_1_P6 + idx_p6 + 
																								(blk_idx_h2 * SIZE_SLICE_1_H2 + idx_h2) * size_idx_p6) * size_idx_p5) * size_idx_h7;
		}
		...
		for (int idx_h3 = 0; idx_h3 < SIZE_SLICE_1_H3; idx_h3++)
		{
			int l_offset = idx_h3 + (idx_h1 + (idx_p4) * SIZE_SLICE_1_H1) * SIZE_SLICE_1_H3;
			h_v2_5_ext_addr[l_offset + i * SIZE_SLICE_1_P4 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_H3] = blk_idx_h3 * SIZE_SLICE_1_H3 + idx_h3 + (blk_idx_h1 * SIZE_SLICE_1_H1 + idx_h1 + (blk_idx_p4 * SIZE_SLICE_1_P4 + idx_p4) * size_idx_h1) * size_idx_h3;
		}
		...
		for (int idx_p6 = 0; idx_p6 < SIZE_SLICE_1_P6; idx_p6++)
		{
			int l_offset = idx_p6 + (idx_h3 + (idx_p5) * SIZE_SLICE_1_H3) * SIZE_SLICE_1_P6;
			h_t2_6_ext_addr[l_offset + i * SIZE_SLICE_1_P5 * SIZE_SLICE_1_H3 * SIZE_SLICE_1_P6] = (blk_idx_p5 * SIZE_SLICE_1_P5 + idx_p5 + (blk_idx_p6 * SIZE_SLICE_1_P6 + idx_p6 + (blk_idx_h3 * SIZE_SLICE_1_H3 + idx_h3) * size_idx_p6) * size_idx_p5) * size_idx_h7;
		}
		...
		for (int idx_h2 = 0; idx_h2 < SIZE_SLICE_1_H2; idx_h2++)
		{
			int l_offset = idx_h2 + (idx_h1 + (idx_p4) * SIZE_SLICE_1_H1) * SIZE_SLICE_1_H2;
			h_v2_6_ext_addr[l_offset + i * SIZE_SLICE_1_P4 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_H2] = blk_idx_h2 * SIZE_SLICE_1_H2 + idx_h2 + (blk_idx_h1 * SIZE_SLICE_1_H1 + idx_h1 + (blk_idx_p4 * SIZE_SLICE_1_P4 + idx_p4) * size_idx_h1) * size_idx_h2;
		}
		...
		for (int idx_p6 = 0; idx_p6 < SIZE_SLICE_1_P6; idx_p6++)
		{
			int l_offset = idx_p6 + (idx_h1 + (idx_p4) * SIZE_SLICE_1_H1) * SIZE_SLICE_1_P6;
			h_t2_7_ext_addr[l_offset + i * SIZE_SLICE_1_P4 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_P6] = (blk_idx_p4 * SIZE_SLICE_1_P4 + idx_p4 + (blk_idx_p6 * SIZE_SLICE_1_P6 + idx_p6 + (blk_idx_h1 * SIZE_SLICE_1_H1 + idx_h1) * size_idx_p6) * size_idx_p4) * size_idx_h7;
		}
		...
		for (int idx_h3 = 0; idx_h3 < SIZE_SLICE_1_H3; idx_h3++)
		{
			int l_offset = idx_h3 + (idx_h2 + (idx_p5) * SIZE_SLICE_1_H2) * SIZE_SLICE_1_H3;
			h_v2_7_ext_addr[l_offset + i * SIZE_SLICE_1_P5 * SIZE_SLICE_1_H2 * SIZE_SLICE_1_H3] = blk_idx_h3 * SIZE_SLICE_1_H3 + idx_h3 + (blk_idx_h2 * SIZE_SLICE_1_H2 + idx_h2 + (blk_idx_p5 * SIZE_SLICE_1_P5 + idx_p5) * size_idx_h2) * size_idx_h3;
		}
		...
		for (int idx_p6 = 0; idx_p6 < SIZE_SLICE_1_P6; idx_p6++)
		{
			int l_offset = idx_p6 + (idx_h2 + (idx_p4) * SIZE_SLICE_1_H2) * SIZE_SLICE_1_P6;
			h_t2_8_ext_addr[l_offset + i * SIZE_SLICE_1_P4 * SIZE_SLICE_1_H2 * SIZE_SLICE_1_P6] = (blk_idx_p4 * SIZE_SLICE_1_P4 + idx_p4 + (blk_idx_p6 * SIZE_SLICE_1_P6 + idx_p6 + (blk_idx_h2 * SIZE_SLICE_1_H2 + idx_h2) * size_idx_p6) * size_idx_p4) * size_idx_h7;
		}
		...
		for (int idx_h3 = 0; idx_h3 < SIZE_SLICE_1_H3; idx_h3++)
		{
			int l_offset = idx_h3 + (idx_h1 + (idx_p5) * SIZE_SLICE_1_H1) * SIZE_SLICE_1_H3;
			h_v2_8_ext_addr[l_offset + i * SIZE_SLICE_1_P5 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_H3] = blk_idx_h3 * SIZE_SLICE_1_H3 + idx_h3 + (blk_idx_h1 * SIZE_SLICE_1_H1 + idx_h1 + (blk_idx_p5 * SIZE_SLICE_1_P5 + idx_p5) * size_idx_h1) * size_idx_h3;
		}
		...
		for (int idx_p6 = 0; idx_p6 < SIZE_SLICE_1_P6; idx_p6++)
		{
			int l_offset = idx_p6 + (idx_h3 + (idx_p4) * SIZE_SLICE_1_H3) * SIZE_SLICE_1_P6;
			h_t2_9_ext_addr[l_offset + i * SIZE_SLICE_1_P4 * SIZE_SLICE_1_H3 * SIZE_SLICE_1_P6] = (blk_idx_p4 * SIZE_SLICE_1_P4 + idx_p4 + (blk_idx_p6 * SIZE_SLICE_1_P6 + idx_p6 + (blk_idx_h3 * SIZE_SLICE_1_H3 + idx_h3) * size_idx_p6) * size_idx_p4) * size_idx_h7;
		}
		...
		for (int idx_h2 = 0; idx_h2 < SIZE_SLICE_1_H2; idx_h2++)
		{
			int l_offset = idx_h2 + (idx_h1 + (idx_p5) * SIZE_SLICE_1_H1) * SIZE_SLICE_1_H2;
			h_v2_9_ext_addr[l_offset + i * SIZE_SLICE_1_P5 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_H2] = blk_idx_h2 * SIZE_SLICE_1_H2 + idx_h2 + (blk_idx_h1 * SIZE_SLICE_1_H1 + idx_h1 + (blk_idx_p5 * SIZE_SLICE_1_P5 + idx_p5) * size_idx_h1) * size_idx_h2;
		}
	}
	...
	h_t2_7_ext_offset 		= (int*)malloc(sizeof(int) * (SIZE_TB_1_X * SIZE_TB_1_Y));
	h_v2_7_ext_offset 		= (int*)malloc(sizeof(int) * (SIZE_TB_1_X * SIZE_TB_1_Y));
	h_t2_8_ext_offset 		= (int*)malloc(sizeof(int) * (SIZE_TB_1_X * SIZE_TB_1_Y));
	h_v2_8_ext_offset 		= (int*)malloc(sizeof(int) * (SIZE_TB_1_X * SIZE_TB_1_Y));
	h_t2_9_ext_offset 		= (int*)malloc(sizeof(int) * (SIZE_TB_1_X * SIZE_TB_1_Y));
	h_v2_9_ext_offset 		= (int*)malloc(sizeof(int) * (SIZE_TB_1_X * SIZE_TB_1_Y));
	...
	for (int idx_h3 = 0; idx_h3 < SIZE_SLICE_1_H3; idx_h3++)
	{
		...
		h_t2_4_ext_offset[t3_index_1] = idx_p6 + (idx_h1) * SIZE_SLICE_1_P6;
		h_v2_4_ext_offset[t3_index_1] = idx_h3 + (idx_h2) * SIZE_SLICE_1_H3;
		h_t2_5_ext_offset[t3_index_1] = idx_p6 + (idx_h2) * SIZE_SLICE_1_P6;
		h_v2_5_ext_offset[t3_index_1] = idx_h3 + (idx_h1) * SIZE_SLICE_1_H3;
		h_t2_6_ext_offset[t3_index_1] = idx_p6 + (idx_h3) * SIZE_SLICE_1_P6;
		h_v2_6_ext_offset[t3_index_1] = idx_h2 + (idx_h1) * SIZE_SLICE_1_H2;
		h_t2_7_ext_offset[t3_index_1] = idx_p6 + (idx_h1) * SIZE_SLICE_1_P6;
		h_v2_7_ext_offset[t3_index_1] = idx_h3 + (idx_h2) * SIZE_SLICE_1_H3;
		h_t2_8_ext_offset[t3_index_1] = idx_p6 + (idx_h2) * SIZE_SLICE_1_P6;
		h_v2_8_ext_offset[t3_index_1] = idx_h3 + (idx_h1) * SIZE_SLICE_1_H3;
		h_t2_9_ext_offset[t3_index_1] = idx_p6 + (idx_h3) * SIZE_SLICE_1_P6;
		h_v2_9_ext_offset[t3_index_1] = idx_h2 + (idx_h1) * SIZE_SLICE_1_H2;
	}
	//
}
							...
							int size_idx_h3, 		int size_idx_h2,		int size_idx_h1,		int size_idx_p6, 		int size_idx_p5, 		int size_idx_p4, 		int size_idx_h7)
{
	...
	// tc_gen_code_pre_IndirectArray_Init()
	h_t3_output_base_addr             = (int*)malloc(sizeof(int) * (n_blocks));
	h_t2_1_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_2_P4 * SIZE_SLICE_2_P5 * SIZE_SLICE_2_H1 * n_blocks);
	h_v2_1_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_2_H3 * SIZE_SLICE_2_H2 * SIZE_SLICE_2_P6 * n_blocks);

	h_t2_2_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_2_P4 * SIZE_SLICE_2_P5 * SIZE_SLICE_2_H2 * n_blocks);
	h_v2_2_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_2_H3 * SIZE_SLICE_2_H1 * SIZE_SLICE_2_P6 * n_blocks);

	h_t2_3_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_2_P4 * SIZE_SLICE_2_P5 * SIZE_SLICE_2_H3 * n_blocks);
	h_v2_3_ext_addr = (int*)malloc(sizeof(int) * SIZE_SLICE_2_H2 * SIZE_SLICE_2_H1 * SIZE_SLICE_2_P6 * n_blocks);
	...
	for (int i = 0; i < n_blocks; i++)
	{
		...
		// Calculating t3
		h_t3_output_base_addr[i] = blk_idx_h3 * SIZE_SLICE_2_H3 * STR_SD2_T3_H3 + blk_idx_h2 * SIZE_SLICE_2_H2 * STR_SD2_T3_H2 + blk_idx_h1 * SIZE_SLICE_2_H1 * STR_SD2_T3_H1 + blk_idx_p6 * SIZE_SLICE_2_P6 * STR_SD2_T3_P6 + blk_idx_p5 * SIZE_SLICE_2_P5 * STR_SD2_T3_P5 + blk_idx_p4 * SIZE_SLICE_2_P4 * STR_SD2_T3_P4;
		...
		{
			int l_offset = idx_p4 + (idx_h1 + (idx_p5) * SIZE_SLICE_2_H1) * SIZE_SLICE_2_P4;
			h_t2_1_ext_addr[l_offset + i * SIZE_SLICE_2_P5 * SIZE_SLICE_2_H1 * SIZE_SLICE_2_P4] = (blk_idx_p4 * SIZE_SLICE_2_P4 + idx_p4 + (blk_idx_p5 * SIZE_SLICE_2_P5 + idx_p5 + (blk_idx_h1 * SIZE_SLICE_2_H1 + idx_h1) * size_idx_p5) * size_idx_p4) * size_idx_h7;
		}
		...
		{
			int l_offset = idx_h3 + (idx_h2 + (idx_p6) * SIZE_SLICE_2_H2) * SIZE_SLICE_2_H3;
			h_v2_1_ext_addr[l_offset + i * SIZE_SLICE_2_P6 * SIZE_SLICE_2_H2 * SIZE_SLICE_2_H3] = blk_idx_h3 * SIZE_SLICE_2_H3 + idx_h3 + (blk_idx_h2 * SIZE_SLICE_2_H2 + idx_h2 + (blk_idx_p6 * SIZE_SLICE_2_P6 + idx_p6) * size_idx_h2) * size_idx_h3;
		}
		...
		for (int idx_p4 = 0; idx_p4 < SIZE_SLICE_2_P4; idx_p4++)
		{
			int l_offset = idx_p4 + (idx_h2 + (idx_p5) * SIZE_SLICE_2_H2) * SIZE_SLICE_2_P4;
			h_t2_2_ext_addr[l_offset + i * SIZE_SLICE_2_P5 * SIZE_SLICE_2_H2 * SIZE_SLICE_2_P4] = (blk_idx_p4 * SIZE_SLICE_2_P4 + idx_p4 + (blk_idx_p5 * SIZE_SLICE_2_P5 + idx_p5 + (blk_idx_h2 * SIZE_SLICE_2_H2 + idx_h2) * size_idx_p5) * size_idx_p4) * size_idx_h7;
		}
		...
		for (int idx_h3 = 0; idx_h3 < SIZE_SLICE_2_H3; idx_h3++)
		{
			int l_offset = idx_h3 + (idx_h1 + (idx_p6) * SIZE_SLICE_2_H1) * SIZE_SLICE_2_H3;
			h_v2_2_ext_addr[l_offset + i * SIZE_SLICE_2_P6 * SIZE_SLICE_2_H1 * SIZE_SLICE_2_H3] = blk_idx_h3 * SIZE_SLICE_2_H3 + idx_h3 + (blk_idx_h1 * SIZE_SLICE_2_H1 + idx_h1 + (blk_idx_p6 * SIZE_SLICE_2_P6 + idx_p6) * size_idx_h1) * size_idx_h3;
		}
		...
		for (int idx_p4 = 0; idx_p4 < SIZE_SLICE_2_P4; idx_p4++)
		{
			int l_offset = idx_p4 + (idx_h3 + (idx_p5) * SIZE_SLICE_2_H3) * SIZE_SLICE_2_P4;
			h_t2_3_ext_addr[l_offset + i * SIZE_SLICE_2_P5 * SIZE_SLICE_2_H3 * SIZE_SLICE_2_P4] = (blk_idx_p4 * SIZE_SLICE_2_P4 + idx_p4 + (blk_idx_p5 * SIZE_SLICE_2_P5 + idx_p5 + (blk_idx_h3 * SIZE_SLICE_2_H3 + idx_h3) * size_idx_p5) * size_idx_p4) * size_idx_h7;
		}
		...
		for (int idx_h2 = 0; idx_h2 < SIZE_SLICE_2_H2; idx_h2++)
		{
			int l_offset = idx_h2 + (idx_h1 + (idx_p6) * SIZE_SLICE_2_H1) * SIZE_SLICE_2_H2;
			h_v2_3_ext_addr[l_offset + i * SIZE_SLICE_2_P6 * SIZE_SLICE_2_H1 * SIZE_SLICE_2_H2] = blk_idx_h2 * SIZE_SLICE_2_H2 + idx_h2 + (blk_idx_h1 * SIZE_SLICE_2_H1 + idx_h1 + (blk_idx_p6 * SIZE_SLICE_2_P6 + idx_p6) * size_idx_h1) * size_idx_h2;
		}
	}
	...
	h_t2_1_ext_offset = (int*)malloc(sizeof(int) * (SIZE_TB_2_X * SIZE_TB_2_Y));
	h_v2_1_ext_offset = (int*)malloc(sizeof(int) * (SIZE_TB_2_X * SIZE_TB_2_Y));
	h_t2_2_ext_offset = (int*)malloc(sizeof(int) * (SIZE_TB_2_X * SIZE_TB_2_Y));
	h_v2_2_ext_offset = (int*)malloc(sizeof(int) * (SIZE_TB_2_X * SIZE_TB_2_Y));
	h_t2_3_ext_offset = (int*)malloc(sizeof(int) * (SIZE_TB_2_X * SIZE_TB_2_Y));
	h_v2_3_ext_offset = (int*)malloc(sizeof(int) * (SIZE_TB_2_X * SIZE_TB_2_Y));
	...
	for (int idx_h3 = 0; idx_h3 < SIZE_SLICE_2_H3; idx_h3++)
	{
		...
		h_t2_1_ext_offset[t3_index_1] = idx_p4 + (idx_h1) * SIZE_SLICE_2_P4;
		h_v2_1_ext_offset[t3_index_1] = idx_h3 + (idx_h2) * SIZE_SLICE_2_H3;
		h_t2_2_ext_offset[t3_index_1] = idx_p4 + (idx_h2) * SIZE_SLICE_2_P4;
		h_v2_2_ext_offset[t3_index_1] = idx_h3 + (idx_h1) * SIZE_SLICE_2_H3;
		h_t2_3_ext_offset[t3_index_1] = idx_p4 + (idx_h3) * SIZE_SLICE_2_P4;
		h_v2_3_ext_offset[t3_index_1] = idx_h2 + (idx_h1) * SIZE_SLICE_2_H2;
	}
	// Do not need Indirect Arrays for Internal Indices
}

//
void Pre_TileApproach_1(int*& h_t3_block_index, int*& h_t3_block_range, int* n_blocks_1, int size_h3, int size_h2, int size_h1, int size_p6, int size_p5, int size_p4, int size_h7)
{
	...
	int n_blk_full_h3 = size_h3 / 4;
	int n_blk_full_h2 = size_h2 / 4;
	int n_blk_full_h1 = size_h1 / 4;
	int n_blk_full_p6 = size_p6 / 4;
	int n_blk_full_p5 = size_p5 / 4;
	int n_blk_full_p4 = size_p4 / 4;
	...
	*n_blocks_1 = n_blk_h3 * n_blk_h2 * n_blk_h1 * n_blk_p6 * n_blk_p5 * n_blk_p4;
	...
	printf ("==========================================================================================================\n");
	printf (" >>> %s <<<\n", __func__);
	printf ("               t3 (h3,h2,h1,p6,p5,p4)\n");
	printf ("                  (%2d,%2d,%2d,%2d,%2d,%2d)(%2d)\n", 	size_h3, 	size_h2, 	size_h1, 	size_p6, 	size_p5, 	size_p4, 	size_h7);
	printf ("           Slices (%2d,%2d,%2d,%2d,%2d,%2d)(%2d)\n",  	4, 			4, 			4, 			4, 			4, 			4, 			16);
	printf ("             Full (%2d,%2d,%2d,%2d,%2d,%2d)\n", 		n_blk_full_h3, n_blk_full_h2, n_blk_full_h1, n_blk_full_p6, n_blk_full_p5, n_blk_full_p4);
	printf ("         Boundary (%2d,%2d,%2d,%2d,%2d,%2d)\n", 		rng_boundary_h3, rng_boundary_h2, rng_boundary_h1, rng_boundary_p6, rng_boundary_p5, rng_boundary_p4);
	printf (" # of Differences (%2d,%2d,%2d,%2d,%2d,%2d) >>> %6d Slices for t3\n", n_blk_h3, n_blk_h2, n_blk_h1, n_blk_p6, n_blk_p5, n_blk_p4, (*n_blocks_1));
	printf ("==========================================================================================================\n");
}

//
void Pre_TileApproach_2(int*& h_t3_block_index, int*& h_t3_block_range, int* n_blocks, int size_h3, int size_h2, int size_h1, int size_p6, int size_p5, int size_p4, int size_h7)
{
	int n_blk_h3 = CEIL(size_h3, 4);
	int n_blk_h2 = CEIL(size_h2, 4);
	int n_blk_h1 = CEIL(size_h1, 4);
	...
	// # of blocks
	*n_blocks 			= n_blk_h3 * n_blk_h2 * n_blk_h1 * n_blk_p6 * n_blk_p5 * n_blk_p4;
	h_t3_block_index 	= (int*)malloc(sizeof(int) * (*n_blocks) * NUM_INDEX);
	h_t3_block_range 	= (int*)malloc(sizeof(int) * (*n_blocks) * NUM_INDEX);
	...
	printf ("             Full (%2d,%2d,%2d,%2d,%2d,%2d)\n", n_blk_full_h3, n_blk_full_h2, n_blk_full_h1, n_blk_full_p6, n_blk_full_p5, n_blk_full_p4);
	printf ("         Boundary (%2d,%2d,%2d,%2d,%2d,%2d)\n", rng_boundary_h3, rng_boundary_h2, rng_boundary_h1, rng_boundary_p6, rng_boundary_p5, rng_boundary_p4);
	printf (" # of Differences (%2d,%2d,%2d,%2d,%2d,%2d) >>> %6d Slices for t3\n", n_blk_h3, n_blk_h2, n_blk_h1, n_blk_p6, n_blk_p5, n_blk_p4, (*n_blocks));
	printf ("==========================================================================================================\n");
}
...
__global__ void kernel_ccsdT_0(double* t3, 
							...
							int stride_t2_4, int stride_t2_5, int stride_t2_6, int stride_t2_7, int stride_t2_8, int stride_t2_9,
							int stride_v2_4, int stride_v2_5, int stride_v2_6, int stride_v2_7, int stride_v2_8, int stride_v2_9,
							...
							int stride_t2_1, int stride_t2_2, int stride_t2_3,
							int stride_v2_1, int stride_v2_2, int stride_v2_3,
							...
							int size_internal)
{
	...
	// tensor contraction
	#pragma unroll 1
	for (int l = 0; l < size_internal; l+= SIZE_INT_UNIT)
	{
		...
		{
			sm_a[threadIdx.x][threadIdx.y + ll * SIZE_TB_2_Y] = d_t2_1[d_t2_1_addr[threadIdx.y + ll * SIZE_TB_2_Y + blockIdx.x * (SIZE_SLICE_2_P4 * SIZE_SLICE_2_P5 * SIZE_SLICE_2_H1)] + (threadIdx.x + l) * stride_t2_1];
		}
		...
		{
			sm_b[threadIdx.y][threadIdx.x + ll * SIZE_TB_2_X] = d_v2_1[d_v2_1_addr[threadIdx.x + ll * SIZE_TB_2_X + blockIdx.x * (SIZE_SLICE_2_H3 * SIZE_SLICE_2_H2 * SIZE_SLICE_2_P6)] + (threadIdx.y + l) * stride_v2_1];
		}
		__syncthreads();
		...
		for (int ll = 0; ll < SIZE_INT_UNIT - internal_upperbound; ll++)
		{
			...
			temp_bv[1] = sm_b[ll][d_v2_1_offset[l_idx_t3] + 16];
			temp_bv[2] = sm_b[ll][d_v2_1_offset[l_idx_t3] + 32];
			temp_bv[3] = sm_b[ll][d_v2_1_offset[l_idx_t3] + 48];
	...
	for (int l = 0; l < size_internal; l+= SIZE_INT_UNIT)
	{
		...
		for (int ll = 0; ll < rng_p5; ll++)
		{
			sm_a[threadIdx.x][threadIdx.y + ll * SIZE_TB_2_Y] = d_t2_2[d_t2_2_addr[threadIdx.y + ll * SIZE_TB_2_Y + blockIdx.x * (SIZE_SLICE_2_P4 * SIZE_SLICE_2_P5 * SIZE_SLICE_2_H2)] + (threadIdx.x + l) * stride_t2_2];
		}
		...
		for (int ll = 0; ll < rng_p6; ll++)
		{
			sm_b[threadIdx.y][threadIdx.x + ll * SIZE_TB_2_X] = d_v2_2[d_v2_2_addr[threadIdx.x + ll * SIZE_TB_2_X + blockIdx.x * (SIZE_SLICE_2_H3 * SIZE_SLICE_2_H1 * SIZE_SLICE_2_P6)] + (threadIdx.y + l) * stride_v2_2];
		}
		__syncthreads();
		...
		for (int ll = 0; ll < SIZE_INT_UNIT - internal_upperbound; ll++)
		{
			...
			temp_bv[1] = sm_b[ll][d_v2_2_offset[l_idx_t3] + 16];
			temp_bv[2] = sm_b[ll][d_v2_2_offset[l_idx_t3] + 32];
			temp_bv[3] = sm_b[ll][d_v2_2_offset[l_idx_t3] + 48];
	...
	for (int l = 0; l < size_internal; l+= SIZE_INT_UNIT)
	{
		...
		for (int ll = 0; ll < rng_p5; ll++)
		{
			sm_a[threadIdx.x][threadIdx.y + ll * SIZE_TB_2_Y] = d_t2_3[d_t2_3_addr[threadIdx.y + ll * SIZE_TB_2_Y + blockIdx.x * (SIZE_SLICE_2_P4 * SIZE_SLICE_2_P5 * SIZE_SLICE_2_H3)] + (threadIdx.x + l) * stride_t2_3];
		}
		...
		for (int ll = 0; ll < rng_p6; ll++)
		{
			sm_b[threadIdx.y][threadIdx.x + ll * SIZE_TB_2_X] = d_v2_3[d_v2_3_addr[threadIdx.x + ll * SIZE_TB_2_X + blockIdx.x * (SIZE_SLICE_2_H2 * SIZE_SLICE_2_H1 * SIZE_SLICE_2_P6)] + (threadIdx.y + l) * stride_v2_3];
		}
		__syncthreads();
		...
		for (int ll = 0; ll < SIZE_INT_UNIT - internal_upperbound; ll++)
		{
			...
			temp_bv[1] = sm_b[ll][d_v2_3_offset[l_idx_t3] + 16];
			temp_bv[2] = sm_b[ll][d_v2_3_offset[l_idx_t3] + 32];
			temp_bv[3] = sm_b[ll][d_v2_3_offset[l_idx_t3] + 48];
	...
	for (int l = 0; l < size_internal; l+= SIZE_INT_UNIT)
	{
		...
		for (int ll = 0; ll < rng_p5; ll++)
		{
			sm_a[threadIdx.x][threadIdx.y + ll * SIZE_TB_1_Y] = d_t2_4[d_t2_4_addr[threadIdx.y + ll * SIZE_TB_1_Y + blockIdx.x * (SIZE_SLICE_1_P5 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_H1)] + (threadIdx.x + l) * stride_t2_4];
		}
		...
		{
			sm_b[threadIdx.y][threadIdx.x + ll * SIZE_TB_1_X] = d_v2_4[d_v2_4_addr[threadIdx.x + ll * SIZE_TB_1_X + blockIdx.x * (SIZE_SLICE_1_H3 * SIZE_SLICE_1_H2 * SIZE_SLICE_1_P4)] + (threadIdx.y + l) * stride_v2_4];
		}
		__syncthreads();
	...
	for (int l = 0; l < size_internal; l+= SIZE_INT_UNIT)
	{
		...
		for (int ll = 0; ll < rng_p5; ll++)
		{
			sm_a[threadIdx.x][threadIdx.y + ll * SIZE_TB_1_Y] = d_t2_5[d_t2_5_addr[threadIdx.y + ll * SIZE_TB_1_Y + blockIdx.x * (SIZE_SLICE_1_P5 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_H2)] + (threadIdx.x + l) * stride_t2_5];
		}
		...
		for (int ll = 0; ll < rng_p4; ll++)
		{
			sm_b[threadIdx.y][threadIdx.x + ll * SIZE_TB_1_X] = d_v2_5[d_v2_5_addr[threadIdx.x + ll * SIZE_TB_1_X + blockIdx.x * (SIZE_SLICE_1_H3 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_P4)] + (threadIdx.y + l) * stride_v2_5];
		}
		__syncthreads();
	...
	for (int l = 0; l < size_internal; l+= SIZE_INT_UNIT)
	{
		...
		for (int ll = 0; ll < rng_p5; ll++)
		{
			sm_a[threadIdx.x][threadIdx.y + ll * SIZE_TB_1_Y] = d_t2_6[d_t2_6_addr[threadIdx.y + ll * SIZE_TB_1_Y + blockIdx.x * (SIZE_SLICE_1_P5 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_H3)] + (threadIdx.x + l) * stride_t2_6];
		}
		...
		for (int ll = 0; ll < rng_p4; ll++)
		{
			sm_b[threadIdx.y][threadIdx.x + ll * SIZE_TB_1_X] = d_v2_6[d_v2_6_addr[threadIdx.x + ll * SIZE_TB_1_X + blockIdx.x * (SIZE_SLICE_1_H2 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_P4)] + (threadIdx.y + l) * stride_v2_6];
		}
		__syncthreads();
	...
	for (int l = 0; l < size_internal; l+= SIZE_INT_UNIT)
	{
		...
		for (int ll = 0; ll < rng_p4; ll++)
		{
			sm_a[threadIdx.x][threadIdx.y + ll * SIZE_TB_1_Y] = d_t2_7[d_t2_7_addr[threadIdx.y + ll * SIZE_TB_1_Y + blockIdx.x * (SIZE_SLICE_1_P4 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_H1)] + (threadIdx.x + l) * stride_t2_7];
		}
		...
		for (int ll = 0; ll < rng_p5; ll++)
		{
			sm_b[threadIdx.y][threadIdx.x + ll * SIZE_TB_1_X] = d_v2_7[d_v2_7_addr[threadIdx.x + ll * SIZE_TB_1_X + blockIdx.x * (SIZE_SLICE_1_H3 * SIZE_SLICE_1_H2 * SIZE_SLICE_1_P5)] + (threadIdx.y + l) * stride_v2_7];
		}
		__syncthreads();
	...
	for (int l = 0; l < size_internal; l+= SIZE_INT_UNIT)
	{
		...
		for (int ll = 0; ll < rng_p4; ll++)
		{
			sm_a[threadIdx.x][threadIdx.y + ll * SIZE_TB_1_Y] = d_t2_8[d_t2_8_addr[threadIdx.y + ll * SIZE_TB_1_Y + blockIdx.x * (SIZE_SLICE_1_P4 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_H2)] + (threadIdx.x + l) * stride_t2_8];
		}
		...
		for (int ll = 0; ll < rng_p5; ll++)
		{
			sm_b[threadIdx.y][threadIdx.x + ll * SIZE_TB_1_X] = d_v2_8[d_v2_8_addr[threadIdx.x + ll * SIZE_TB_1_X + blockIdx.x * (SIZE_SLICE_1_H3 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_P5)] + (threadIdx.y + l) * stride_v2_8];
		}
		__syncthreads();
	...
	for (int l = 0; l < size_internal; l+= SIZE_INT_UNIT)
	{
		...
		for (int ll = 0; ll < rng_p4; ll++)
		{
			sm_a[threadIdx.x][threadIdx.y + ll * SIZE_TB_1_Y] = d_t2_9[d_t2_9_addr[threadIdx.y + ll * SIZE_TB_1_Y + blockIdx.x * (SIZE_SLICE_1_P4 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_H3)] + (threadIdx.x + l) * stride_t2_9];
		}
		...
		for (int ll = 0; ll < rng_p5; ll++)
		{
			sm_b[threadIdx.y][threadIdx.x + ll * SIZE_TB_1_X] = d_v2_9[d_v2_9_addr[threadIdx.x + ll * SIZE_TB_1_X + blockIdx.x * (SIZE_SLICE_1_H2 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_P5)] + (threadIdx.y + l) * stride_v2_9];
		}
		__syncthreads();
...
double* d_t2_4, const int* __restrict__ d_t2_4_addr, const int* __restrict__ d_t2_4_offset, double* d_t2_5, const int* __restrict__ d_t2_5_addr, const int* __restrict__ d_t2_5_offset, double* d_t2_6, const int* __restrict__ d_t2_6_addr, const int* __restrict__ d_t2_6_offset, double* d_t2_7, const int* __restrict__ d_t2_7_addr, const int* __restrict__ d_t2_7_offset, double* d_t2_8, const int* __restrict__ d_t2_8_addr, const int* __restrict__ d_t2_8_offset, double* d_t2_9, const int* __restrict__ d_t2_9_addr, const int* __restrict__ d_t2_9_offset, 
double* d_v2_4, const int* __restrict__ d_v2_4_addr, const int* __restrict__ d_v2_4_offset, double* d_v2_5, const int* __restrict__ d_v2_5_addr, const int* __restrict__ d_v2_5_offset, double* d_v2_6, const int* __restrict__ d_v2_6_addr, const int* __restrict__ d_v2_6_offset, double* d_v2_7, const int* __restrict__ d_v2_7_addr, const int* __restrict__ d_v2_7_offset, double* d_v2_8, const int* __restrict__ d_v2_8_addr, const int* __restrict__ d_v2_8_offset, double* d_v2_9, const int* __restrict__ d_v2_9_addr, const int* __restrict__ d_v2_9_offset, 
int stride_t2_4, int stride_t2_5, int stride_t2_6, int stride_t2_7, int stride_t2_8, int stride_t2_9,
int stride_v2_4, int stride_v2_5, int stride_v2_6, int stride_v2_7, int stride_v2_8, int stride_v2_9,
int stride_reg_x, int stride_reg_y,
int size_internal)
...
double* d_t2_1, const int* __restrict__ d_t2_1_addr, const int* __restrict__ d_t2_1_offset, double* d_t2_2, const int* __restrict__ d_t2_2_addr, const int* __restrict__ d_t2_2_offset, double* d_t2_3, const int* __restrict__ d_t2_3_addr, const int* __restrict__ d_t2_3_offset, 
double* d_v2_1, const int* __restrict__ d_v2_1_addr, const int* __restrict__ d_v2_1_offset, double* d_v2_2, const int* __restrict__ d_v2_2_addr, const int* __restrict__ d_v2_2_offset, double* d_v2_3, const int* __restrict__ d_v2_3_addr, const int* __restrict__ d_v2_3_offset, 
int stride_t2_1, int stride_t2_2, int stride_t2_3,
int stride_v2_1, int stride_v2_2, int stride_v2_3,
int stride_reg_x, int stride_reg_y,
int size_internal)
...
// created by tc_gen_code_Kernel()
__global__ void kernel_ccsdT_2_full(double* t3, const int* __restrict__ t3_block_range_2, const int* __restrict__ t3_output_base_addr_2, const int* __restrict__ t3_output_offset_2, 
double* d_t2_1, const int* __restrict__ d_t2_1_addr, const int* __restrict__ d_t2_1_offset, double* d_t2_2, const int* __restrict__ d_t2_2_addr, const int* __restrict__ d_t2_2_offset, double* d_t2_3, const int* __restrict__ d_t2_3_addr, const int* __restrict__ d_t2_3_offset, 
double* d_v2_1, const int* __restrict__ d_v2_1_addr, const int* __restrict__ d_v2_1_offset, double* d_v2_2, const int* __restrict__ d_v2_2_addr, const int* __restrict__ d_v2_2_offset, double* d_v2_3, const int* __restrict__ d_v2_3_addr, const int* __restrict__ d_v2_3_offset, 
int stride_t2_1, int stride_t2_2, int stride_t2_3,
int stride_v2_1, int stride_v2_2, int stride_v2_3,
...
int size_internal)
{
	...
	int l_idx_t3         = threadIdx.x + threadIdx.y * SIZE_TB_2_X;
	int t3_base_thread   = t3_output_base_addr_2[blockIdx.x] + t3_output_offset_2[l_idx_t3];
	int internal_upperbound   = 0;
	int internal_offset;
...
// created by tc_gen_code_Kernel()
__global__ void kernel_ccsdT_2_full_full(double* t3, const int* __restrict__ t3_block_range_2, const int* __restrict__ t3_output_base_addr_2, const int* __restrict__ t3_output_offset_2, 
double* d_t2_1, const int* __restrict__ d_t2_1_addr, const int* __restrict__ d_t2_1_offset, double* d_t2_2, const int* __restrict__ d_t2_2_addr, const int* __restrict__ d_t2_2_offset, double* d_t2_3, const int* __restrict__ d_t2_3_addr, const int* __restrict__ d_t2_3_offset, 
double* d_v2_1, const int* __restrict__ d_v2_1_addr, const int* __restrict__ d_v2_1_offset, double* d_v2_2, const int* __restrict__ d_v2_2_addr, const int* __restrict__ d_v2_2_offset, double* d_v2_3, const int* __restrict__ d_v2_3_addr, const int* __restrict__ d_v2_3_offset, 
int stride_t2_1, int stride_t2_2, int stride_t2_3,
int stride_v2_1, int stride_v2_2, int stride_v2_3,
...
//
extern "C"
void sd_t_d1_all_cuda(int size_h3, int size_h2, int size_h1, int size_p6, int size_p5, int size_p4, int size_h7,
						double* t3,
						...
						int opt_rt)
{
	...
	// (1) Block-Ranges for Partial Tiles
	Pre_TileApproach_1(h_t3_block_index_1, h_t3_block_range_1, &num_blocks_kernel_1, size_h3, size_h2, size_h1, size_p6, size_p5, size_p4, size_h7);
	Pre_TileApproach_2(h_t3_block_index_2, h_t3_block_range_2, &num_blocks_kernel_2, size_h3, size_h2, size_h1, size_p6, size_p5, size_p4, size_h7);

	// (2) Pre-Computed Arrays
	Pre_PreComputedArrays_1(h_t3_output_base_addr_1, 	host_t2_4_addr, 	host_v2_4_addr,
														host_t2_5_addr, 	host_v2_5_addr,
														host_t2_6_addr, 	host_v2_6_addr,
														host_t2_7_addr, 	host_v2_7_addr,
														host_t2_8_addr, 	host_v2_8_addr,
														host_t2_9_addr, 	host_v2_9_addr,
							h_t3_output_ext_offset_1,	host_t2_4_offset, 	host_v2_4_offset,
														host_t2_5_offset,	host_v2_5_offset,
														host_t2_6_offset,	host_v2_6_offset,
														host_t2_7_offset,	host_v2_7_offset,
	...
	Pre_PreComputedArrays_2(h_t3_output_base_addr_2,	host_t2_1_addr, 	host_v2_1_addr,
														host_t2_2_addr,		host_v2_2_addr,
														host_t2_3_addr,		host_v2_3_addr,
							h_t3_output_ext_offset_2,	host_t2_1_offset, 	host_v2_1_offset,
	...
	cudaMalloc((void**) &dev_t2_4_addr, sizeof(int) * SIZE_SLICE_1_H1 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_P5 * num_blocks_kernel_1);
	cudaMalloc((void**) &dev_v2_4_addr, sizeof(int) * SIZE_SLICE_1_P4 * SIZE_SLICE_1_H2 * SIZE_SLICE_1_H3 * num_blocks_kernel_1);
	cudaMalloc((void**) &dev_t2_5_addr, sizeof(int) * SIZE_SLICE_1_H2 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_P5 * num_blocks_kernel_1);
	cudaMalloc((void**) &dev_v2_5_addr, sizeof(int) * SIZE_SLICE_1_P4 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_H3 * num_blocks_kernel_1);
	cudaMalloc((void**) &dev_t2_6_addr, sizeof(int) * SIZE_SLICE_1_H3 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_P5 * num_blocks_kernel_1);
	cudaMalloc((void**) &dev_v2_6_addr, sizeof(int) * SIZE_SLICE_1_P4 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_H2 * num_blocks_kernel_1);
	cudaMalloc((void**) &dev_t2_7_addr, sizeof(int) * SIZE_SLICE_1_H1 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_P4 * num_blocks_kernel_1);
	cudaMalloc((void**) &dev_v2_7_addr, sizeof(int) * SIZE_SLICE_1_P5 * SIZE_SLICE_1_H2 * SIZE_SLICE_1_H3 * num_blocks_kernel_1);
	cudaMalloc((void**) &dev_t2_8_addr, sizeof(int) * SIZE_SLICE_1_H2 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_P4 * num_blocks_kernel_1);
	cudaMalloc((void**) &dev_v2_8_addr, sizeof(int) * SIZE_SLICE_1_P5 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_H3 * num_blocks_kernel_1);
	cudaMalloc((void**) &dev_t2_9_addr, sizeof(int) * SIZE_SLICE_1_H3 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_P4 * num_blocks_kernel_1);
	cudaMalloc((void**) &dev_v2_9_addr, sizeof(int) * SIZE_SLICE_1_P5 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_H2 * num_blocks_kernel_1);
	cudaMalloc((void**) &dev_t2_1_addr, sizeof(int) * SIZE_SLICE_2_H1 * SIZE_SLICE_2_P5 * SIZE_SLICE_2_P4 * num_blocks_kernel_2);
	cudaMalloc((void**) &dev_v2_1_addr, sizeof(int) * SIZE_SLICE_2_P6 * SIZE_SLICE_2_H2 * SIZE_SLICE_2_H3 * num_blocks_kernel_2);
	cudaMalloc((void**) &dev_t2_2_addr, sizeof(int) * SIZE_SLICE_2_H2 * SIZE_SLICE_2_P5 * SIZE_SLICE_2_P4 * num_blocks_kernel_2);
	cudaMalloc((void**) &dev_v2_2_addr, sizeof(int) * SIZE_SLICE_2_P6 * SIZE_SLICE_2_H1 * SIZE_SLICE_2_H3 * num_blocks_kernel_2);
	cudaMalloc((void**) &dev_t2_3_addr, sizeof(int) * SIZE_SLICE_2_H3 * SIZE_SLICE_2_P5 * SIZE_SLICE_2_P4 * num_blocks_kernel_2);
	cudaMalloc((void**) &dev_v2_3_addr, sizeof(int) * SIZE_SLICE_2_P6 * SIZE_SLICE_2_H1 * SIZE_SLICE_2_H2 * num_blocks_kernel_2);
	...
	cudaMalloc((void**) &dev_t2_7_offset, sizeof(int) * SIZE_TB_1_X * SIZE_TB_1_Y);
	cudaMalloc((void**) &dev_v2_7_offset, sizeof(int) * SIZE_TB_1_X * SIZE_TB_1_Y);
	cudaMalloc((void**) &dev_t2_8_offset, sizeof(int) * SIZE_TB_1_X * SIZE_TB_1_Y);
	cudaMalloc((void**) &dev_v2_8_offset, sizeof(int) * SIZE_TB_1_X * SIZE_TB_1_Y);
	cudaMalloc((void**) &dev_t2_9_offset, sizeof(int) * SIZE_TB_1_X * SIZE_TB_1_Y);
	cudaMalloc((void**) &dev_v2_9_offset, sizeof(int) * SIZE_TB_1_X * SIZE_TB_1_Y);
	cudaMalloc((void**) &dev_t2_1_offset, sizeof(int) * SIZE_TB_2_X * SIZE_TB_2_Y);
	cudaMalloc((void**) &dev_v2_1_offset, sizeof(int) * SIZE_TB_2_X * SIZE_TB_2_Y);
	cudaMalloc((void**) &dev_t2_2_offset, sizeof(int) * SIZE_TB_2_X * SIZE_TB_2_Y);
	cudaMalloc((void**) &dev_v2_2_offset, sizeof(int) * SIZE_TB_2_X * SIZE_TB_2_Y);
	cudaMalloc((void**) &dev_t2_3_offset, sizeof(int) * SIZE_TB_2_X * SIZE_TB_2_Y);
	cudaMalloc((void**) &dev_v2_3_offset, sizeof(int) * SIZE_TB_2_X * SIZE_TB_2_Y);
	...
	cudaMemcpy(dev_t2_4_addr, host_t2_4_addr, sizeof(int) * SIZE_SLICE_1_H1 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_P5 * num_blocks_kernel_1, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_v2_4_addr, host_v2_4_addr, sizeof(int) * SIZE_SLICE_1_P4 * SIZE_SLICE_1_H2 * SIZE_SLICE_1_H3 * num_blocks_kernel_1, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_t2_5_addr, host_t2_5_addr, sizeof(int) * SIZE_SLICE_1_H2 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_P5 * num_blocks_kernel_1, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_v2_5_addr, host_v2_5_addr, sizeof(int) * SIZE_SLICE_1_P4 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_H3 * num_blocks_kernel_1, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_t2_6_addr, host_t2_6_addr, sizeof(int) * SIZE_SLICE_1_H3 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_P5 * num_blocks_kernel_1, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_v2_6_addr, host_v2_6_addr, sizeof(int) * SIZE_SLICE_1_P4 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_H2 * num_blocks_kernel_1, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_t2_7_addr, host_t2_7_addr, sizeof(int) * SIZE_SLICE_1_H1 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_P4 * num_blocks_kernel_1, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_v2_7_addr, host_v2_7_addr, sizeof(int) * SIZE_SLICE_1_P5 * SIZE_SLICE_1_H2 * SIZE_SLICE_1_H3 * num_blocks_kernel_1, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_t2_8_addr, host_t2_8_addr, sizeof(int) * SIZE_SLICE_1_H2 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_P4 * num_blocks_kernel_1, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_v2_8_addr, host_v2_8_addr, sizeof(int) * SIZE_SLICE_1_P5 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_H3 * num_blocks_kernel_1, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_t2_9_addr, host_t2_9_addr, sizeof(int) * SIZE_SLICE_1_H3 * SIZE_SLICE_1_P6 * SIZE_SLICE_1_P4 * num_blocks_kernel_1, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_v2_9_addr, host_v2_9_addr, sizeof(int) * SIZE_SLICE_1_P5 * SIZE_SLICE_1_H1 * SIZE_SLICE_1_H2 * num_blocks_kernel_1, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_t2_1_addr, host_t2_1_addr, sizeof(int) * SIZE_SLICE_2_H1 * SIZE_SLICE_2_P5 * SIZE_SLICE_2_P4 * num_blocks_kernel_2, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_v2_1_addr, host_v2_1_addr, sizeof(int) * SIZE_SLICE_2_P6 * SIZE_SLICE_2_H2 * SIZE_SLICE_2_H3 * num_blocks_kernel_2, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_t2_2_addr, host_t2_2_addr, sizeof(int) * SIZE_SLICE_2_H2 * SIZE_SLICE_2_P5 * SIZE_SLICE_2_P4 * num_blocks_kernel_2, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_v2_2_addr, host_v2_2_addr, sizeof(int) * SIZE_SLICE_2_P6 * SIZE_SLICE_2_H1 * SIZE_SLICE_2_H3 * num_blocks_kernel_2, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_t2_3_addr, host_t2_3_addr, sizeof(int) * SIZE_SLICE_2_H3 * SIZE_SLICE_2_P5 * SIZE_SLICE_2_P4 * num_blocks_kernel_2, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_v2_3_addr, host_v2_3_addr, sizeof(int) * SIZE_SLICE_2_P6 * SIZE_SLICE_2_H1 * SIZE_SLICE_2_H2 * num_blocks_kernel_2, cudaMemcpyHostToDevice);
	...
	cudaMemcpy(dev_t2_7_offset, host_t2_7_offset, sizeof(int) * SIZE_TB_1_X * SIZE_TB_1_Y, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_v2_7_offset, host_v2_7_offset, sizeof(int) * SIZE_TB_1_X * SIZE_TB_1_Y, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_t2_8_offset, host_t2_8_offset, sizeof(int) * SIZE_TB_1_X * SIZE_TB_1_Y, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_v2_8_offset, host_v2_8_offset, sizeof(int) * SIZE_TB_1_X * SIZE_TB_1_Y, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_t2_9_offset, host_t2_9_offset, sizeof(int) * SIZE_TB_1_X * SIZE_TB_1_Y, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_v2_9_offset, host_v2_9_offset, sizeof(int) * SIZE_TB_1_X * SIZE_TB_1_Y, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_t2_1_offset, host_t2_1_offset, sizeof(int) * SIZE_TB_2_X * SIZE_TB_2_Y, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_v2_1_offset, host_v2_1_offset, sizeof(int) * SIZE_TB_2_X * SIZE_TB_2_Y, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_t2_2_offset, host_t2_2_offset, sizeof(int) * SIZE_TB_2_X * SIZE_TB_2_Y, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_v2_2_offset, host_v2_2_offset, sizeof(int) * SIZE_TB_2_X * SIZE_TB_2_Y, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_t2_3_offset, host_t2_3_offset, sizeof(int) * SIZE_TB_2_X * SIZE_TB_2_Y, cudaMemcpyHostToDevice);
	cudaMemcpy(dev_v2_3_offset, host_v2_3_offset, sizeof(int) * SIZE_TB_2_X * SIZE_TB_2_Y, cudaMemcpyHostToDevice);
	...
	// h7 for t2 -> all "1"
	int STR_SD2_V2_4_H7 = size_p4 * size_h2 * size_h3;
	int STR_SD2_V2_5_H7 = size_p4 * size_h1 * size_h3;
	int STR_SD2_V2_6_H7 = size_p4 * size_h1 * size_h2; 
	int STR_SD2_V2_7_H7 = size_p5 * size_h2 * size_h3;
	int STR_SD2_V2_8_H7 = size_p5 * size_h1 * size_h3;
	int STR_SD2_V2_9_H7 = size_p5 * size_h1 * size_h2;
	int STR_SD2_V2_1_H7 = size_p6 * size_h2 * size_h3;
	int STR_SD2_V2_2_H7 = size_p6 * size_h1 * size_h3;
	int STR_SD2_V2_3_H7 = size_p6 * size_h1 * size_h2;
		...
		size_p6 % SIZE_SLICE_1_P6 == 0 && size_p5 % SIZE_SLICE_1_P5 == 0 && size_p4 % SIZE_SLICE_1_P4 == 0)
	{
        ...
        {
			printf ("[fusedKernels] External (Full) && Internal (Full) >>> Type #3\n");
            if (opt_rt == 1)
            {
                printf ("[fusedKernels] Running a Kernel with Register Transpose\n");
                ...
                dev_t2_4, dev_t2_4_addr, dev_t2_4_offset, dev_t2_5, dev_t2_5_addr, dev_t2_5_offset, dev_t2_6, dev_t2_6_addr, dev_t2_6_offset, dev_t2_7, dev_t2_7_addr, dev_t2_7_offset, dev_t2_8, dev_t2_8_addr, dev_t2_8_offset, dev_t2_9, dev_t2_9_addr, dev_t2_9_offset, 
				dev_v2_4, dev_v2_4_addr, dev_v2_4_offset, dev_v2_5, dev_v2_5_addr, dev_v2_5_offset, dev_v2_6, dev_v2_6_addr, dev_v2_6_offset, dev_v2_7, dev_v2_7_addr, dev_v2_7_offset, dev_v2_8, dev_v2_8_addr, dev_v2_8_offset, dev_v2_9, dev_v2_9_addr, dev_v2_9_offset, 
				1, 1, 1, 1, 1, 1, 
                STR_SD2_V2_4_H7, STR_SD2_V2_5_H7, STR_SD2_V2_6_H7, STR_SD2_V2_7_H7, STR_SD2_V2_8_H7, STR_SD2_V2_9_H7, 
				...
				1, 1, 1, 
                STR_SD2_V2_1_H7, STR_SD2_V2_2_H7, STR_SD2_V2_3_H7,
            ...
            {
                // Depends on # of Fused Kernel
                printf ("[fusedKernels] Running 2 Diff. Kernels without Register Transpose\n");	
        ...
        {
			printf ("[fusedKernels] External (Full) && Internal (Partial) >>> Type #2\n");
            if (opt_rt == 1)
            {
                printf ("[fusedKernels] Running a Kernel with Register Transpose\n");
    ...
    {
        printf ("[fusedKernels] External (Partial) && Internal (Partial) >>> Type #1\n");
        if (opt_rt == 1)
        {
            printf ("[fusedKernels] Running a Kernel with Register Transpose\n");
	...
	printf ("[%s] Done, Please check the output\n", __func__);
}


//
extern "C"
void sd_t_d1_all_cuda_(int size_h3, int size_h2, int size_h1, int size_p6, int size_p5, int size_p4, int size_h7,
						double* t3,
						double* t2_1, double* v2_1, double* t2_2, double* v2_2,	double* t2_3, double* v2_3, 
						double* t2_4, double* v2_4, double* t2_5, double* v2_5,	double* t2_6, double* v2_6,
						double* t2_7, double* v2_7, double* t2_8, double* v2_8, double* t2_9, double* v2_9,
...
//
extern "C"
void sd_t_d1_all_cuda__(int size_h3, int size_h2, int size_h1, int size_p6, int size_p5, int size_p4, int size_h7,
						double* t3, 
						double* t2_all, double* v2_all, int opt_rt)
{
	double *t2_1,*t2_2,*t2_3,*t2_4,*t2_5,*t2_6,*t2_7,*t2_8,*t2_9;
	double *v2_1,*v2_2,*v2_3,*v2_4,*v2_5,*v2_6,*v2_7,*v2_8,*v2_9;
	
	int size_t2_1,size_t2_2,size_t2_3,size_t2_4,size_t2_5,size_t2_6,size_t2_7,size_t2_8;
	int size_v2_1,size_v2_2,size_v2_3,size_v2_4,size_v2_5,size_v2_6,size_v2_7,size_v2_8;
