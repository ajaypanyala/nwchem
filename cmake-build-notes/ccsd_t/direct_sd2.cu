							...
							int size_idx_h3, 		int size_idx_h2,		int size_idx_h1,		int size_idx_p6, 		int size_idx_p5, 	int size_idx_p4, 		int size_idx_p7)
{
	...
	printf ("=======\n");
	printf ("The Sizes of Pre-Computed Arrays\n");
	printf ("  (1) h_t3_output_base_addr: %12d\n", sizeof(int) * n_blocks_1);
	printf ("  (2) h_t2_1_ext_addr: %12d\n", sizeof(int) * 64 * n_blocks_1);
...
void Pre_TileApproach_2(int*& h_t3_block_index, int*& h_t3_block_range, int* n_blocks_2, int size_h3, int size_h2, int size_h1, int size_p6, int size_p5, int size_p4, int size_p7)
{
	...
	*n_blocks_2 = n_blk_h3 * n_blk_h2 * n_blk_h1 * n_blk_p6 * n_blk_p5 * n_blk_p4;
	...
	printf ("             Full (%2d,%2d,%2d,%2d,%2d,%2d)\n", n_blk_full_h3, n_blk_full_h2, n_blk_full_h1, n_blk_full_p6, n_blk_full_p5, n_blk_full_p4);
	printf ("         Boundary (%2d,%2d,%2d,%2d,%2d,%2d)\n", rng_boundary_h3, rng_boundary_h2, rng_boundary_h1, rng_boundary_p6, rng_boundary_p5, rng_boundary_p4);
	printf (" # of Differences (%2d,%2d,%2d,%2d,%2d,%2d) >>> %6d Slices for t3\n", n_blk_h3, n_blk_h2, n_blk_h1, n_blk_p6, n_blk_p5, n_blk_p4, (*n_blocks_2));
	printf ("==========================================================================================================\n");
}
...
void sd_t_d2_all_cuda(int size_h3, int size_h2, int size_h1, int size_p6, int size_p5, int size_p4, int size_p7, 
	...
	double* t2_9, double* v2_9, int opt_register_transpose)
{
	...
	double* t2_9, double* v2_9, int opt_register_transpose)
{
	...
	t2_7, v2_7,
	t2_8, v2_8,
	t2_9, v2_9, opt_register_transpose);
}

//
extern "C"
void sd_t_d2_all_cuda__(int size_h3, int size_h2, int size_h1, int size_p6, int size_p5, int size_p4, int size_p7,
						double* t3,	
						double* t2_all, double* v2_all, int opt_rt)
{
	...
	// for sd2,
	size_t2_1 = size_h2 * size_h1 * size_p4 * size_p7;
	size_t2_2 = size_h3 * size_h2 * size_p4 * size_p7;
	size_t2_3 = size_h3 * size_h1 * size_p4 * size_p7;
	size_t2_4 = size_h2 * size_h1 * size_p5 * size_p7;	//
	size_t2_5 = size_h3 * size_h2 * size_p5 * size_p7;
	size_t2_6 = size_h3 * size_h1 * size_p5 * size_p7;
	size_t2_7 = size_h2 * size_h1 * size_p6 * size_p7;
	size_t2_8 = size_h3 * size_h2 * size_p6 * size_p7;

	size_v2_1 = size_p5 * size_p6 * size_h3 * size_p7;
	size_v2_2 = size_p5 * size_p6 * size_h1 * size_p7;
	size_v2_3 = size_p5 * size_p6 * size_h2 * size_p7;
	size_v2_4 = size_p4 * size_p6 * size_h3 * size_p7;
	size_v2_5 = size_p4 * size_p6 * size_h1 * size_p7;
	size_v2_6 = size_p4 * size_p6 * size_h2 * size_p7;
	size_v2_7 = size_p4 * size_p5 * size_h3 * size_p7;
	size_v2_8 = size_p4 * size_p5 * size_h1 * size_p7;
